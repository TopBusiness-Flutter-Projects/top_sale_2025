...
class OrderDetailsModel {
    ...
    factory OrderDetailsModel.fromJson(Map<String, dynamic> json) => OrderDetailsModel(
        ...
        orderLines: json["order_lines"] == null ? [] : List<Line>.from(json["order_lines"]!.map((x) => Line.fromJson(x))),
...
class Invoice {
   ...
   dynamic state;
    ...
    factory Invoice.fromJson(Map<String, dynamic> json) => Invoice(
        ...
        invoiceLines: json["invoice_lines"] == null ? [] : List<Line>.from(json["invoice_lines"]!.map((x) => Line.fromJson(x))),
    );
