...
import 'package:top_sale/features/home_screen/cubit/state.dart';
                                      ...
                                      Navigator.push(context, MaterialPageRoute(
                                        builder: (context) {
                                          return PdfViewerPage(
                                            baseUrl:
                                                '${EndPoints.printPayment}${cubit.allPaymentsModel.result!.payments![index].paymentId.toString()}',
                                          );
